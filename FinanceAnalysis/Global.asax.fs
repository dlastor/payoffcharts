...
open FinanceAnalysis.Convertors
open OptionsPricing
...
type Global() =
    ...
    member x.Application_Start() =
        MarketData.authKey <- "&auth_token=VP8Yryjzdv-3kxtyH5Uc"
        MarketData.loadAllStocks [LSE;EURONEXT]
        let test = MarketData.stockLookup "TEST"
